...
FullTimeEmployee fullTimeEmployee = new FullTimeEmployee(101,"Varshith","TENDULKAR",6000,2000,"50-50, EAST, MUMBAI");
		fullTimeEmployee.showDetails();
		fullTimeEmployee.sendMessage();
	
		PartTimeEmployee partTimeEmployee = new PartTimeEmployee(102,"Srujan","Meghanath",150,80,"20-20,WEST, MUMBAI");
